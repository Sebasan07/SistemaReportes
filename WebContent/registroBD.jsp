				...
				<form method="post" action="editar/enviar">
					<div class="form-row">
						...
						<div class="form-group col-md-4">
							<label for="driver">Driver</label> <input type="text"
								name="driver" class="form-control">
						</div>

						<div class="form-group col-md-4">
							<label for="aditional">Adicional</label> <input type="text"
								name="aditional" class="form-control">
						</div>
			...
			<footer class="footer-container">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col">&copy;2021 - Todos los derechos reservados</div>
